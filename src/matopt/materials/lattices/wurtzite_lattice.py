...
from matopt.aml.util import DBL_TOL
...
class WurtziteLattice(UnitCellLattice):
    ...
    def getLatticeVectors(self):
        ...
        """
        # Wurtzite has a hexagonal unit cell
        # a = b ≠ c, α = β = 90°, γ = 120°
        a = self.IAD * np.sqrt(8 / 3)  # Lattice parameter a
        c = self.IAD * np.sqrt(8)  # Lattice parameter c
