...
from matopt.materials.transform_func import ScaleFunc, RotateFunc, ReflectFunc
...
class PerovskiteLattice(UnitCellLattice):
    ...
    def getLatticeVectors(self):
        ...
        Returns:
            numpy.ndarray: 3x3 array where each row is a lattice vector [a, b, c]
        """
        # Perovskite has an orthorhombic unit cell with lattice parameters a, b, c
        return np.array([
            [self.A, 0, 0],
            [0, self.B, 0],
            [0, 0, self.C]
