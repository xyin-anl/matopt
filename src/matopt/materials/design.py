...
from matopt.materials.parsers.PDB import readPointsAndAtomsFromPDB, writeDesignToPDB
from matopt.materials.parsers.XYZ import readPointsAndAtomsFromXYZ, writeDesignToXYZ
from matopt.materials.parsers.CFG import readPointsAndAtomsFromCFG, writeDesignToCFG
from matopt.materials.parsers.POSCAR import (
    readPointsAndAtomsFromPOSCAR,
    writeDesignToPOSCAR,
)
from matopt.materials.parsers.pymatgen import design_to_structure, structure_to_design
...
class Design(object):
    ...
    def to_pymatgen(self):
        """Convert this Design to a pymatgen Structure object."""
        return design_to_structure(self)
    
    @classmethod
    def from_pymatgen(cls, structure):
        """Create a Design from a pymatgen Structure object."""
        return structure_to_design(structure)
